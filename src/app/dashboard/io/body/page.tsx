...
export default async function BodyPage() {
  ...
  const metrics = await getBodyMetrics(user.id, 30);
  ...
  return (
    <div className="px-4 sm:px-8 py-6 sm:py-8 max-w-[900px] space-y-6">
      <div>
        <h1 className="text-2xl font-extrabold text-[#f0f2f8] tracking-tight">Body Metrics</h1>
